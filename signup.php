...
<head>
    ...
    <title>TaskBoard - Crear Cuenta</title>
        ...
        <div class="auth-container">
            <div class="auth-card">
                <div class="auth-header">
                    ...
                    <p class="subtitle">Crea tu cuenta y comienza a organizar</p>
                </div>
                ...
                <button type="button" class="btn btn-secondary btn-full" onclick="window.location.href='login.php'">
                    Ir a Iniciar Sesión
                </button>
